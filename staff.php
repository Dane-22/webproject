        ...
        <div class="navbar-wrapper">
            <div class="navbar-brand header-logo">
                <a href="index.php" class="b-brand">
                    <!--<div class="b-bg">-->
                       <img src="assets/images/dmmmsu.png" style="height: 30px; width: 30px;"></img>
                   <!--</div>-->                    <span class="b-title">DMMMSU ATBI</span>
                </a>
            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        <a href="javascript:" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Incubatees</span></a>
                        <ul class="pcoded-submenu">
                            <li class=""><a href="bc_button.html" class="">Phinry's Fruits & Vegetables Farm</a></li>
                            <li class=""><a href="bc_badges.html" class="">G's Duckery</a></li>
                            <li class=""><a href="bc_breadcrumb-pagination.html" class="">Perr-res Fruit Food Products Processing</a></li>
                            <li class=""><a href="bc_collapse.html" class="">Vel Seirra Integrated Farm</a></li>
                            <li class=""><a href="bc_tabs.html" class="">Rabon Seaside Gracilaria Seaweed Association</a></li>
                            <li class=""><a href="bc_typography.html" class="">ELDICA Seafood Processing</a></li>
                            <li class=""><a href="bc_button.html" class="">Bottled Bangus Products</a></li>
                            <li class=""><a href="bc_button.html" class="">Chevon Products in Retort Pouch</a></li>
                    ...
                    <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item active">
                        <a href="facultyprofile.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Manage User</span></a>
                    </li>
                    <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                        <a href="ongoing.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Manage Staff</span></a>
                    </li>
                    <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                        <a href="ongoing.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Manage ATBI products posting</span></a>
                    </li>
                    <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                        <a href="ongoing.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Customer's feedback</span></a>
                    </li>
                    <!--<li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                        <a href="completed.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Completed Research Form</span></a>
                    </li>
                    <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                        <a href="ipreg.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">IP Registrations</span></a>
                    </li>
                    <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                        <a href="publication.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Publications</span></a>
                    </li>
                    <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                        <a href="presentations.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Presentations</span></a>
                    </li>
                    <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                        <a href="policyreccomendations.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Policy Reccomendations</span></a>
                    </li>-->
                                                ...
                                                <table class="table table-hover">
                                                    <tbody>
                                                        <tr class="unread">
                                                            ...
                                                            <td>
                                                                <h6 class="mb-1">Daniel Rillera</h6>
                                                                <p class="m-0">Bangus Sisig</p>
                                                            </td>
                                                            <td>
                                                                <h6 class="text-muted"><i class="fas fa-circle text-c-green f-10 m-r-15"></i>11 MAY</h6>
                                                            </td>
                                                            <td><!--<a href="#!" class="label theme-bg2 text-white f-12">Reject</a>-->
                                                                <a href="#!" class="label theme-bg text-white f-12">Done</a></td>
                                                        </tr>
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="assets/images/user/avatar-2.jpg" alt="activity-user"></td>
                                                            <td>
                                                                <h6 class="mb-1">Leslie Soriane</h6>
                                                                <p class="m-0">Chili Garlic Oil</p>
                                                            </td>
                                                            <td>
                                                                <h6 class="text-muted"><i class="fas fa-circle text-c-red f-10 m-r-15"></i>11 MAY</h6>
                                                            </td>
                                                            <td><!--<a href="#!" class="label theme-bg2 text-white f-12">Reject</a>--><a href="#!" class="label theme-bg text-white f-12">Done</a></td>
                                                        </tr>
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="assets/images/user/avatar-3.jpg" alt="activity-user"></td>
                                                            <td>
                                                                <h6 class="mb-1">Rodeo Claro</h6>
                                                                <p class="m-0">Seaweed Chips</p>
                                                            </td>
                                                            <td>
                                                                <h6 class="text-muted"><i class="fas fa-circle text-c-green f-10 m-r-15"></i>9 MAY</h6>
                                                            </td>
                                                            <td><!--<a href="#!" class="label theme-bg2 text-white f-12">Reject</a>--><a href="#!"class="label theme-bg text-white f-12">Done</a></td>
                                                        </tr>
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="assets/images/user/avatar-1.jpg" alt="activity-user"></td>
                                                            <td>
                                                                <h6 class="mb-1">Rose Caroline Ramos</h6>
                                                                <p class="m-0">Duck Binagoongan</p>
                                                            </td>
                                                            <td>
                                                                <h6 class="text-muted f-w-300"><i class="fas fa-circle text-c-red f-10 m-r-15"></i>19 MAY</h6>
                                                            </td>
                                                            <td><!--<a href="#!" class="label theme-bg2 text-white f-12">Reject</a>--><a href="#!" class="label theme-bg2 text-white f-12">Cancelled</a></td>
                                                        </tr>
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="assets/images/user/avatar-2.jpg" alt="activity-user"></td>
                                                            <td>
                                                                <h6 class="mb-1">Mariane Joy Rillera</h6>
                                                                <p class="m-0">Mushroom Kropeck</p>
                                                            </td>
                                                            <td>
                                                                <h6 class="text-muted"><i class="fas fa-circle text-c-green f-10 m-r-15"></i>21 July</h6>
                                                            </td>
                                                            <td><!--<a href="#!" class="label theme-bg2 text-white f-12">Reject</a>--><a href="#!" class="label theme-bg text-white f-12">Done</a></td>
                                                        </tr>
                                                    </tbody>
                                    ...
                                    <div class="card card-event">
                                        <div class="card-block">
                                            <div class="row align-items-center justify-content-center">
                                                <div class="col">
                                                    <h5 class="m-0">Total User</h5>
                                                </div>
                                                <div class="col-auto">
                                                    <label class="label theme-bg2 text-white f-14 f-w-400 float-right"></label>
                                                </div>
                                            </div>  
                                            <h2 class="mt-3 f-w-300">5<sub class="text-muted f-14">Users</sub></h2>
                                        ...
                                        <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle m-r-10" style="width:40px;" src="assets/images/user/avatar-1.jpg" alt="activity-user">Daniel Rillera</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Bangus Sisig</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">₱140</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0 text-c-green">Delivered</h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="assets/images/user/avatar-2.jpg" alt="activity-user">Leslie Soriane</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Chili Garlic Oil</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">₱80</h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="assets/images/user/avatar-3.jpg" alt="activity-user">Rodeo Claro</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Seaweed Chips</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">50</h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="assets/images/user/avatar-1.jpg" alt="activity-user">Rose Caroline Ramos</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Duck Binagoongan(Spicy)</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">₱120</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0 text-c-purple">Cancelled</h6>
                                                        </td>
                                                        <td class="text-right"><i class="fas fa-circle text-c-purple f-10"></i></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="assets/images/user/avatar-1.jpg" alt="activity-user">Mariane Joy Rillera</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Mushroom Kropeck</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">₱100</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0 text-c-green">Deivered</h6>
                                                        </td>
                                                        <td class="text-right"><i class="fas fa-circle text-c-green f-10"></i></td>
                                                    </tr>
                                                </tbody>
